    ...
    <div class="header home-header">
      ...
      <div class="carousel slide" data-ride="carousel" id="home-slider">
        ...
        <div class="carousel-inner">
          <div class="shared-hosting-header reseller-slide item active">
            <div class="container" style="margin: 0px auto">
              ...
              <div class="col-md-6">
                ...
                <div class="call-to-action">
                  ...
                  <a class="ybtn ybtn-shadow ybtn-white smooth-scroll" href="reseller-hosting">See Plans</a>
                </div>
              </div>
            </div>
          </div>
          <div class="shared-hosting-header shared-slide item">
            <div class="container" style="margin: 1.5% auto;">
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                ...
                <div class="call-to-action">
                  <a class="ybtn ybtn-shadow ybtn-green" href="" id="get_support"></a>
                  <a class="ybtn ybtn-shadow ybtn-white smooth-scroll" href="web-hosting">Know More</a>
                </div>
              </div>
            </div>
          </div>

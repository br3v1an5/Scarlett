...
<html lang="en">
  <head>
		<!-- head -->
		<title>Scarlett - Web Hosting</title>
		<!-- include Depedencies -->
    ...
    <div class="container">
      <div class="row-flex justify-content-center fhost-ftrue-non-ind">
          ...
          <div class="col-md-9">
              ...
              <p>Our clients' satisfaction is our #1 priority! That's why each person who signs up with Scarlett is completely protected by our 100% Risk-Free Guarantee Program. Simply sign up, try our product and if OWL Internet cheap web hosting services won't satisfy your needs - we'll provide you an instant refund. But we're pretty sure that you'll enjoy being part of OWL Internet community.</p>
          </div>
      </div>
    </div>
